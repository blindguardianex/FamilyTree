...
insert into addresses (id, created, updated, status, country_id, region_id, locality_id, text_address)
    values
        (nextval('addresses_id_seq'), now(), null, 'ACTIVE', (select id from countries where countries.name = 'Российская Федерация' and countries.code = 'RUS'), (select id from regions where name = 'Тульская область' and code = '71'), (select id from localities where name = 'Тула'), 'Российская Федерация, Тульская область, Тула город'),
        (nextval('addresses_id_seq'), now(), null, 'ACTIVE', (select id from countries where countries.name = 'Российская Федерация' and countries.code = 'RUS'), (select id from regions where name = 'Тульская область' and code = '71'), (select id from localities where name = 'Замарино'), 'Российская Федерация, Тульская область, Замарино деревня'),
        (nextval('addresses_id_seq'), now(), null, 'ACTIVE', (select id from countries where countries.name = 'Российская Федерация' and countries.code = 'RUS'), (select id from regions where regions.name = 'Нижегородская область' and regions.code = '52'), (select id from localities where name = 'Дзержинск'), 'Российская Федерация, Нижегородская область, Дзержинск город'),
        (nextval('addresses_id_seq'), now(), null, 'ACTIVE', (select id from countries where countries.name = 'Российская Федерация' and countries.code = 'RUS'), (select id from regions where regions.name = 'Красноярский край' and regions.code = '24'), (select id from localities where name = 'Норильск'), 'Российская Федерация, Красноярский край, Норильск город'),
        (nextval('addresses_id_seq'), now(), null, 'ACTIVE', (select id from countries where countries.name = 'Российская Федерация' and countries.code = 'RUS'), (select id from regions where regions.name = 'Калининградская область' and regions.code = '39'), (select id from localities where name = 'Советск'), 'Российская Федерация, Калининградская область, Советск город');